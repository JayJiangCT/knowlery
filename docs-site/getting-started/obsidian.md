...
This guide walks through installing the Knowlery plugin, initializing a vault, and understanding what changes after setup. (Starting with an agent instead? See [Getting Started](./index).)
