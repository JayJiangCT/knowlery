...
- `AGENTS.md` — the entry file for Codex, OpenCode, and other agents: Knowlery's operating rules plus instructions to read `KNOWLEDGE.md` and the rule files first
